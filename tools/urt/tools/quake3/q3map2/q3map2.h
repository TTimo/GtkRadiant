...
/* version */
#define Q3MAP_VERSION   "FS21"
#define Q3MAP_MOTD      "Based on q3map2_fs20g, which was forked from 2.5.16"
...
#define EXTERNAL_LIGHTMAP_RAD       "lm_%04d_%d.tga"
...
typedef struct drawSurfRef_s
{
	...
	int outputNum;
	//int      MergeAssign; //27: for merging for better T&L perf
}
drawSurfRef_t;
...
Q_EXTERN qboolean radbump Q_ASSIGN( qfalse );
Q_EXTERN qboolean radbumpdebug Q_ASSIGN( qfalse );
Q_EXTERN int radbumppass Q_ASSIGN( 0 );
Q_EXTERN int radbumpsize Q_ASSIGN( 0 );
Q_EXTERN byte               *radfilebuffer;
...
Q_EXTERN qboolean noCollapse Q_ASSIGN( qtrue );           /// This flag sucks.
...
Q_EXTERN qboolean noboundstest Q_ASSIGN( qfalse );
