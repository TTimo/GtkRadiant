...
{
  AABBExtend< ct_int<0> >::apply(aabb, point);
  AABBExtend< ct_int<1> >::apply(aabb, point);
  AABBExtend< ct_int<2> >::apply(aabb, point);
}
...
{
  AABBExtend< ct_int<0> >::apply(aabb, other);
  AABBExtend< ct_int<1> >::apply(aabb, other);
  AABBExtend< ct_int<2> >::apply(aabb, other);
}
...
{
  return aabb_intersects_point_dimension< ct_int<0> >(aabb, point)
    && aabb_intersects_point_dimension< ct_int<1> >(aabb, point)
    && aabb_intersects_point_dimension< ct_int<2> >(aabb, point);
}
...
{
  return aabb_intersects_aabb_dimension< ct_int<0> >(aabb, other)
    && aabb_intersects_aabb_dimension< ct_int<1> >(aabb, other)
    && aabb_intersects_aabb_dimension< ct_int<2> >(aabb, other);
}
