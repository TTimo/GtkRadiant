...
#define CLIP_X_LT_W(p) (Vector4ClipLT< ct_int<0> >::compare(p))
#define CLIP_X_GT_W(p) (Vector4ClipGT< ct_int<0> >::compare(p))
#define CLIP_Y_LT_W(p) (Vector4ClipLT< ct_int<1> >::compare(p))
#define CLIP_Y_GT_W(p) (Vector4ClipGT< ct_int<1> >::compare(p))
#define CLIP_Z_LT_W(p) (Vector4ClipLT< ct_int<2> >::compare(p))
#define CLIP_Z_GT_W(p) (Vector4ClipGT< ct_int<2> >::compare(p))
...
inline std::size_t homogenous_clip_triangle(Vector4 clipped[9])
{
  Vector4 buffer[9];
  std::size_t count = 3;
  count = Vector4ClipPolygon< Vector4ClipLT< ct_int<0> > >::apply(clipped, clipped + count, buffer);
  count = Vector4ClipPolygon< Vector4ClipGT< ct_int<0> > >::apply(buffer, buffer + count, clipped);
  count = Vector4ClipPolygon< Vector4ClipLT< ct_int<1> > >::apply(clipped, clipped + count, buffer);
  count = Vector4ClipPolygon< Vector4ClipGT< ct_int<1> > >::apply(buffer, buffer + count, clipped);
  count = Vector4ClipPolygon< Vector4ClipLT< ct_int<2> > >::apply(clipped, clipped + count, buffer);
  return Vector4ClipPolygon< Vector4ClipGT< ct_int<2> > >::apply(buffer, buffer + count, clipped);
}
